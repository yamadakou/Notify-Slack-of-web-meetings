...
namespace dcinc.api
{
    public static class SlackChannels
    {
            ...
            ILogger log)
        {
            ...
            Uri collectionUri = UriFactory.CreateDocumentCollectionUri("Notify-Slack-of-web-meetings-db", "SlackChannels");
            ...
            ILogger log)
        {
            ...
            foreach (var documentItem in documentItems)
            {
                ...
                Uri documentUri = UriFactory.CreateDocumentUri("Notify-Slack-of-web-meetings-db", "SlackChannels", documentItem.Id);
